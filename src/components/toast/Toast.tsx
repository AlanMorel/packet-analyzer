    ...
    return (
        <div
            className={`z-101 fixed bottom-0 left-0 right-0 translate-y-full transform select-none px-4 text-center opacity-0 transition-all duration-500 ease-out ${
                active ? "toast--active -translate-y-10 transform opacity-100" : ""
            }`}
        >
            <div className="relative inline-block rounded-md bg-black bg-opacity-75 px-8 py-3 text-lg text-white shadow-lg backdrop-blur">
